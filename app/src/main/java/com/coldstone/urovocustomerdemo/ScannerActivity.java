...
public class ScannerActivity extends AppCompatActivity {
    ...
    private void showResetDialog() {
        ...
        builder.setPositiveButton(android.R.string.yes, new OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                ResetAsyncTask task = new ResetAsyncTask(ScannerActivity.this);
                task.execute("reset");
                dialog.dismiss();
            }
        });
    ...
    public static class ScanSettingsBarcode extends PreferenceFragment implements Preference.OnPreferenceChangeListener {
        ...
        private ScannerActivity mScanDemo = null;
        ...
        public void setScanManagerDemo(ScannerActivity demo, String key) {
            mScanDemo = demo;
            mBarcodeKey = key;
        }
    ...
    public static class SettingsBarcodeList extends PreferenceFragment implements Preference.OnPreferenceChangeListener {
        ...
        public void setScanManagerDemo(ScannerActivity demo) {
            mScanDemo = demo;
        }
